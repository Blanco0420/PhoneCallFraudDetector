...
func HasNumber() predicate.Provider {
...
func HasNumberWith(preds ...predicate.Number) predicate.Provider {
	return predicate.Provider(func(s *sql.Selector) {
		step := newNumberStep()
...
func HasComment() predicate.Provider {
	return predicate.Provider(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCommentWith(preds ...predicate.Comment) predicate.Provider {
	return predicate.Provider(func(s *sql.Selector) {
		step := newCommentStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasBusiness() predicate.Provider {
	return predicate.Provider(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBusinessWith(preds ...predicate.Business) predicate.Provider {
	return predicate.Provider(func(s *sql.Selector) {
